...
def get_csv_metrics(tempdir):
    ...
    print('\x1b[32mINFO\x1b[0m: {} csv files found...'.format(len(csv_files)))
...
def get_dd_metrics(csv_metrics, keys, t):
    ...
    try:
        ...
        print(
            '\x1b[31mERROR\x1b[0m: There was an error with the Datadog API call, current value of dd_metrics is: \n {}'.format(
                dd_metrics))
