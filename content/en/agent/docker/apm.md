...
| `DD_APM_FILTER_TAGS_REQUIRE`      | Defines a white space seperated list of required tags that traces must have in order to be sent to Datadog.                                                                                                                                                                                                                                                                                                     |
| `DD_APM_FILTER_TAGS_REJECT`      | Defines a white space seperated list of of rejection tags. The Agent drops traces that have these tags.       |
