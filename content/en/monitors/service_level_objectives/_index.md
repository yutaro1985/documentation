...
If you were to set a 100% target, that would mean you have an error budget of 0%. When error budget no longer represents acceptable risk, you face difficulty finding alignment between the conflicting priorities of maintaining customer-facing reliability and investing in feature development. In addition, SLOs with target values of 100% lead to division by zero errors in SLO Error Budget Alert evaluation. 
