...
See the instructions for standard [Agent installation][1] for platform-specific details. **Note**: the Live Processes is not available for the source install method of the Agent.
